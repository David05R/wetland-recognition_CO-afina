...
export default function Home() {
  return (
    <main className="relative w-screen min-h-screen justify-centerflex flex-col bg-background-dark overflow-hidden">
      <div className="absolute flex flex-col items-start top-14 left-14 z-10">
        ...
        <Link href="/map">
          <div className="bg-white text-primary mt-4 px-6 w-fit h-11 flex items-center rounded-full font-poppins">
            Inicia Wetlands.io
          </div>
        </Link>
      </div>
